...
import 'Login.dart';
import 'package:TALREJA/cart.dart';
import 'mycart.dart';
import 'myorders.dart';
import 'package:TALREJA/order.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(userid: globals.userid!), // Pass userid here
    );
  }
}
              ...
              child: userData.isEmpty
                  ...
                  : GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        String imageUrl = '${globals.baseImageUrl}${item['ig_image']}';
                        return categoryCard(
                          item['ig_name'],
                          imageUrl,
                          item['ig_id'] ?? '',
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: imagePath.startsWith('http')
                      ...
                      : const AssetImage('assets/images/nocategory.jpg')
                          as ImageProvider,
                  fit: BoxFit.cover,
                ),
              ),
